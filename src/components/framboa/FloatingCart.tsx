...
const FloatingCart = () => {
  ...
  return (
    <div className="fixed bottom-6 left-0 right-0 z-50 px-4 md:px-0 flex justify-center animate-in slide-in-from-bottom-10 fade-in duration-300">
      <button className="flex w-full max-w-md items-center justify-between rounded-full bg-gradient-primary px-7 py-4 text-primary-foreground shadow-card shadow-wine transition-smooth hover:scale-[1.02] active:scale-[0.98]">
